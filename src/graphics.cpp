...
std::vector<Animation*> MeshImporter::importAnimations(const std::string &filePath) {
    Assimp::Importer importer;
...
std::vector<Animation*> MeshImporter::importAnimationsInternal(const aiScene *scene) {
    // Import animations
